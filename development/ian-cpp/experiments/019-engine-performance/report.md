# Where can complete-engine time and memory be reduced safely?

**Proposal only: no measured outcome.**

IAN-EXP-019 · Historical phase 08 · Aims IA2, IA3.
...
Early client memory savings are not an engine baseline. Requires compatible complete runs and a frozen resource/correctness contract.
...
- [IAN-EXP-018: Can an explicit secondary rule stabilize scale selection?](../018-scale-selection/report.md) — motivation.
- [IAN-EXP-003: Does native execution improve repeated-solve costs?](../003-persistent-sequences/report.md) — motivation.
