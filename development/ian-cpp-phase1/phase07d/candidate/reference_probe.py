...
from reference import POLICY, make_reference, sha, write, FROZEN, components
...
def run(inp, output, condition, input_hash):
    assert inp.get('numerical_policy')==POLICY,'unsupported_policy'
...
if __name__ == '__main__':
    ...
    p.add_argument('condition', choices=['evaluated'])
    a = p.parse_args()
