...
for(name in c("nonuniform_curve","variable_density_patch","nearby_curved_arms","pressmat_hellinger_subset")) {
 ...
 r<-dgraphs:::create.ian.graph(binary("features.bin",ref$n,ref$p),distances=binary("distances.bin",ref$n,ref$n),specimen.ids=ref$ids,diagnostics="full",max.solves=80L)
