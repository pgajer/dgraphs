...
| 5. Controlled scientific evaluation | Bounded study complete; audit pending | Begin declared synthetic neighborhood/geodesic and known conditional-mean benchmarks against simpler methods; specify cohort population/assay/visit contracts before real-data application | Reproducible data generation, fair comparisons, dependence-aware evaluation and independent audit; engine acceptance and estimator acceptance remain separate |
