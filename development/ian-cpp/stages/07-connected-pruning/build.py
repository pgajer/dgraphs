...
base=['clang++','-std=c++17','-O2','-ffp-contract=off','-fno-fast-math','-Wno-deprecated-declarations','-I'+str(S/'core/include'),'-I'+str(S/'core/src'),'-I'+str(S/'Clarabel.cpp/include'),'-DSOURCE_HASH="'+identity+'"','-DCONFIG_HASH="'+config+'"']
def call(name,cmd):
