...
The [public-interface qualification](035-public-interface/report.md) now tests explicit setup and exported defaults against saved results in two private Mac arm64 R installations. Its author checks pass; independent review is pending. The next research study will evaluate the scientific effects of preserving connections, separately from interface correctness.
